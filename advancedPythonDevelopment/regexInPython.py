...
email = "jose.r_e@teclado.com"
expression = "[a-z\._]+@[a-z]+\.(com|me|ru)"
...
print(price_number + 12.00)

price = "Price: $18,649.510"
expression = "[A-z]+:\s\$(?P<price_value>[\d,]+\.\d+)"
matches = re.search(expression, price)
print(matches.group(0))
print(matches.group("price_value"))
